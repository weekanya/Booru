...
object Strings {
    ...
    fun aboutAppDesc(lang: AppLanguage): String = when (lang) {
        AppLanguage.RUSSIAN -> "Booru • Версия 5.0"
        AppLanguage.JAPANESE -> "Booru • バージョン 5.0"
        AppLanguage.CHINESE -> "Booru • 版本 5.0"
        AppLanguage.KOREAN -> "Booru • 버전 5.0"
        AppLanguage.ARABIC -> "Booru • الإصدار 5.0"
        else -> "Booru • Version 5.0"
    }
